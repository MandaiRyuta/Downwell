...
void Camera::Update()
{
	...
	if (Character::GetPos().x > fCameraLeftLine&& Character::GetPos().x < fCameraRightLine && !bShake_)
	{
		vPosition_.y = Character::GetPos().y;
	}
	else if (Character::GetPos().x > fCameraLeftLine&& Character::GetPos().x < fCameraRightLine && !bShake_)
	{
